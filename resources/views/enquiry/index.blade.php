                ...
                <li>
                    <div class = "flex items-center">
                        ...
                        <a href="{{ route('enquiries.index') }}"
                            class = "ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-indigo-400 dark:hover:text-white">Enquiries</a>
                    </div>
                </li>
            </ol>
        </nav>
            ...
            <div class="rounded-t mb-0 px-4 border-0">
                <div class="flex flex-wrap gap-2 items-center justify-between">
                    <div class="flex gap-2 items-center">
                        <form id="EnquiryFilter" action="{{ route('enquiries.index') }}" method="GET">
                    ...
                    <button
                        ...
                        type="button" onclick="showDiv('EnquiryModal')">Add New</button>

                </div>
            </div>

            <div id="enquiry-table">
            @include('enquiry.partials.enquiry-table')
            </div>
        </section>
    </div>
